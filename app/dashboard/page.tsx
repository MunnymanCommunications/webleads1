  ...
  const loadDashboardData = async () => {
    ...
    try {
      const [companiesData, visitsData] = await Promise.all([
        ...
        crmApi.getVisits(session.client.id),
      ])
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Viewed {visit.pages.length} page{visit.pages.length !== 1 ? "s" : ""} •{" "}
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{session?.client.domain}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium">Status</p>
                    <Badge variant={session?.client.isActive ? "default" : "secondary"}>
                      {session?.client.isActive ? "Active" : "Inactive"}
                    </Badge>
                  </div>
                </CardContent>
              </Card>
