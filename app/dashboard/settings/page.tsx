                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="companyName" defaultValue={session?.client.name} />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="domain">Primary Domain</Label>
                      <Input id="domain" defaultValue={session?.client.domain} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="size" placeholder="e.g., 1-10, 11-50, 51-200" />
                    </div>
                  </div>
                  <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => copyToClipboard(session?.client.apiKey || "", "apiKey")}
                          >
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">jane@{session?.client.domain}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">mike@{session?.client.domain}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">User</Badge>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Company enrichment and logos</p>
                          </div>
                        </div>
                        <Badge variant="outline">Available</Badge>
                      </div>
